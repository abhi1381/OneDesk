...
import { getIsAdmin } from "../api/getAdmin";
      ...
      >
        <Toolbar>
          ...
          <Typography variant="h6" noWrap>
            ...
            <span style={{ color: "#FF1493", fontSize: "32px", fontWeight: "bold" }}>One</span> <span style={{ color: "#FF1493", fontSize: "32px", fontWeight: "bold" }}>Desk</span> <sup style={{ fontWeight: "bold", fontSize: "16px", color: "#212121" }}>Dash</sup>
          </Typography>
